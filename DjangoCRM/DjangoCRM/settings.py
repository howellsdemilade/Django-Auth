...
SECRET_KEY = 'django-insecure-)z4$@#v+$^&m6hejv%xqw)^x6v#55ovzn-uv64$c*-s#ps9&kk'
...
# SESSION_TIMEOUT_REDIRECT = 'home' # Add your URL

# if SESSION_TIMEOUT_REDIRECT == 'home':
#     messages.success(request,"expired") 
